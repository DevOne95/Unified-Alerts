...
import 'package:unified_alerts/src/Account/view/account_full_view.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                LogHistoryView(
                    loginHistoryModel: accountModel!.loginHistory[0]),
              ],
            ),
          ),
        ),
  ...
  void _showBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return AccountFullView(accountModel: accountModel);
      },
    );
  }
}
